...
-- Up
-- Initialisiert das Core-Datenmodell basierend auf Doc 01 und V2.2 Ergänzungen.
...
-- Down
-- DROP TABLE IF EXISTS deletion_audit_logs;
-- DROP TABLE IF EXISTS sale_events;
-- DROP TABLE IF EXISTS marketplace_projections;
...
-- DROP TYPE IF EXISTS projection_lifecycle_state;
-- DROP TYPE IF EXISTS truth_state;
-- DROP TYPE IF EXISTS item_lifecycle_state;